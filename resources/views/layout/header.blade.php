...
<html>
    ...
    <body>
        ...
        <br>
            <div class="col-container" style="width:100%;position: fixed; top: 0px;background-color: white; padding: 10px">
                <div class="col" style="width:300px;position: fixed;top: -15px;background-color: white;">
                    <h1 style="text-align:left;font-family: sans-serif;">
                        Tutorial Tube
                    </h1>
                </div>
                <div class="col" style=" margin-left: 700px;">
                    ...
                    <h4>
                        {{strtoupper(session()->get('loggedUser')->username)}} |
